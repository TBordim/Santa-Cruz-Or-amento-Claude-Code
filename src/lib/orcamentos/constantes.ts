...
export const OPCOES_VERNIZ = ["B. D'água", "B. D'água Fosco", "Fungicida", "UV Brilho", "UV Flexo", "Perolado", "Blister PVC", "Blister PET", "High Gloss", "Impermeabilizante", "Outro"] as const;
