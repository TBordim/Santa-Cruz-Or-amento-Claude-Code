...
export const config = {
  // Todas as rotas, exceto assets estáticos, imagens, o manifest e o service worker do PWA e a própria rota de
  ...
  matcher: [
    "/((?!api/auth|_next/static|_next/image|favicon.ico|manifest.webmanifest|sw.js|icon-192.png|icon-512.png|icon-maskable-512.png|apple-touch-icon.png|logo-santa-cruz.png).*)",
  ],
};
